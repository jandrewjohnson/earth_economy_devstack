...
3.  Create a new conda environment and install required packages with the following 2 mamba commands. The second command will take quite a while (10+ minutes).
    1.  `mamba create -n environment_name`
    2.  `mamba install hazelbean`
