...
If you are starting a project of your own rather than running someone else's, copy [`run_template_downstream_user.py`](https://github.com/jandrewjohnson/earth_economy_devstack/blob/main/examples/run_templates/run_template_downstream_user.py) as the seed — it is the worked example of importing a library read-only and adding your own tasks around its task tree.
