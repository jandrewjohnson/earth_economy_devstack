---
aliases:
  - /earth_economy_devstack/gtappy_aggregation.html
---

# GTAP Aggregation: building an aggregated database with GTAPAgg2
...
That directory is what gets copied into a model version directory in [Run GTAP](gtappy_rungtap.qmd), and what a GTAPPy run file points at as its data directory for that aggregation label.