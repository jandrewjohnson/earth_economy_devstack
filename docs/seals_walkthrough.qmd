...
``` python
# Instead of the bare hb.ProjectFlow() above, name the project explicitly and it is
# placed at ~/<extra_dirs>/<project_name>. All files will be created in this directory.
# run_mode='full' gives each run a fresh timestamped dir; use run_mode='check' if you
# don't want to recreate everything each time — then each task will not recreate
# files that already exist.
p = hb.ProjectFlow(project_name='test_examples', run_mode='full',
