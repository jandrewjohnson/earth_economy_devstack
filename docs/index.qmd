...
The pages that remain here — Hazelbean, Global InVEST, GTAPpy, and the Methods
section — cover the shared libraries and conventions that all of the models build on.
