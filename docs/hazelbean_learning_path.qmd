...
Hazelbean follows a consistent, organized workflow pattern that makes geospatial analysis predictable and reproducible: initialize a ProjectFlow, let it create the directory structure, discover and load your data, process it, analyze it, and export organized results.

That pattern — and the execution model ProjectFlow runs underneath it — are drawn out as flowcharts on the [workflow diagrams](workflow_diagram.qmd) page.
...
### [Step-by-Step Tutorial Examples](hazelbean_tutorials.qmd)
...
|------|------------|------|------------|
| **[Step 1](hazelbean_tutorials.qmd#step-1-project-setup)** | Project Setup | 5 min | ProjectFlow, Directory Structure |
| **[Step 2](hazelbean_tutorials.qmd#step-2-data-loading)** | Data Loading | 10 min | get_path(), File Discovery, Metadata |
| **[Step 3](hazelbean_tutorials.qmd#step-3-processing)** | Processing | 15 min | Array Operations, Transformations |
| **[Step 4](hazelbean_tutorials.qmd#step-4-analysis)** | Analysis | 20 min | Multi-raster Operations, Statistics |
| **[Step 5](hazelbean_tutorials.qmd#step-5-export-results)** | Export Results | 15 min | Professional Organization, Documentation |
...
1. **Start:** [Tutorial Examples Step 1](hazelbean_tutorials.qmd#step-1-project-setup)
...
**→ [Start with Step 1 of the Tutorial](hazelbean_tutorials.qmd#step-1-project-setup)**
...
**→ [Jump to Step 5 (Results Export)](hazelbean_tutorials.qmd#step-5-export-results) to see the end goal**
...
[Start Learning with Step 1 →](hazelbean_tutorials.qmd#step-1-project-setup){.btn .btn-primary style="background: linear-gradient(45deg, #1976d2, #42a5f5); color: white; padding: 15px 30px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 18px; display: inline-block; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"}
:::
