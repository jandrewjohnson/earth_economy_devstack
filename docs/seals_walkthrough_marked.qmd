...
::: r-fit-text
# Naming the project explicitly places it at ~/<extra_dirs>/<project_name>.
# run_mode='full' gives each run a fresh timestamped dir; use run_mode='check' if you
# don't want to recreate everything each time.
:::

# All files will be created in this project_dir.
