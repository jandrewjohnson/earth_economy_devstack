...
Release history for the Earth-Economy Devstack itself — hazelbean, ProjectFlow,
the conventions, and the shared examples.

Each product keeps its own release notes:
[SEALS](https://justinandrewjohnson.com/seals/user_guide/release_notes.html) ·
[GTAP-InVEST](https://justinandrewjohnson.com/gtap_invest/user_guide/release_notes.html) ·
[Hazelbean](hazelbean_release_notes.qmd) ·
[GTAPPy](gtappy_release_notes.qmd) ·
[Base Data](base_data_release_notes.qmd).
...
Earlier ProjectFlow-era entries (v0.4.0, v0.5.0) have moved to the [Hazelbean release notes](hazelbean_release_notes.qmd).
