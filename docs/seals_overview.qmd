...
Full instructions for installing SEALS can be found in the [Installation Steps](installation.qmd). SEALS is under active development and is changing rapidly. We have submitted this code for publication but are waiting on reviews. 
