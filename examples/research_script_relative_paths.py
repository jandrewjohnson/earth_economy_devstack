...
file_path = os.path.join(base_data_dir, "poll_dep_greater_0.xlsx")
df = pd.read_excel(file_path)

# Define base directories

base_crop_data_dir = os.path.join(base_data_dir, "HarvestedAreaYield175Crops_Geotiff/HarvestedAreaYield175Crops_Geotiff/GeoTiff")
pollination_suff_path = os.path.join(base_data_dir, "aligned_poll_suff_to_apple.tif")
output_raster_dir = os.path.join(base_data_dir, "pollination_dependent_crops")
zonal_output_dir = os.path.join(base_data_dir, "crop_production_by_country")

price_data_path = os.path.join(base_data_dir, "Price_data/Prices_E_All_Data_ori.csv")
...
zone_input_path = os.path.join(base_data_dir, "ee_r264_correspondence.shp")
